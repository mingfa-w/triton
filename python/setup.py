...
def download_and_copy_npu(name, src_path, dst_path, variable, version, url_func):
    ...
    dst_path = os.path.join(base_dir, "bytedance", "triton", "backends", "triton_x", "npu", dst_path)  # final binary path
...
setup(
    ...
    name='bytedtriton',  # add the 'byted' prefix for package name
